...
The files are stored in `~/mnt/eo-nas1/data/swisstopo/DEM` and are named `sa3D_MINX_MAXY.zarr` where MINX and MINY correspond to the coordinates of the top left corner of the file, in meters (EPSG:32632).
